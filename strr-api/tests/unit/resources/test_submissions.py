...
from strr_api.models import Submission as SubmissionModel, User as UserModel
from strr_api.models import SubmissionType
from strr_api.services import SubmissionService
...
def test_post_plots_db_mocked(app, session, client, jwt, mocker, requests_mock):
    ...
    assert pay_api_mock.request_history[0].json() == {
        ...
        'businessInfo': {'corpType': 'STRR', 'businessIdentifier': json_data['businessIdentifier']},
